/*
Bài 13: Số nguyên lớn là các số nguyên có giá trị rất lớn và không thể biểu diễn 
bằng các kiểu dữ liệu nguyên cơ bản. Để biểu diễn số nguyên lớn, ta có thể dùng 
kiểu struct như sau:
    struct bigNum{
        char sign;
        char num[101];
    };
Nhiệm vụ các bạn là đa năng hóa các toán tử để thực hiện các phép toán số học với
...
// trừ hai số nguyên dương lớn, num1 > num2
// Le Dinh Tri Tue - 0909 - 732833
...
// kiểm tra xem số nguyên lớn num1 có lớn hơn num2 không
// Le Dinh Tri Tue - 0909 - 732833
